...
export const OverviewPanel = React.memo(
  React.forwardRef<HTMLDivElement, TabPanelProps>(
    ({ id, ariaLabelledBy, hidden, ariaHidden, tabIndex, className }, ref) => (
      <div
        id={id}
        role="tabpanel"
...
export const SystemPanel = React.memo(
  React.forwardRef<HTMLDivElement, TabPanelProps>(
    ({ id, ariaLabelledBy, hidden, ariaHidden, tabIndex, className }, ref) => (
      <div
        id={id}
...
export const CalculatorPanel = React.memo(
  React.forwardRef<HTMLDivElement, TabPanelProps>(
    ({ id, ariaLabelledBy, hidden, ariaHidden, tabIndex, className }, ref) => (
      <div
        id={id}
